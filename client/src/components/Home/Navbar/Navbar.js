...
//               <button
//                 className="focus:outline-none text-white xl:hidden"
...
//               </button>
//               {openMenu && (
//                 <div className="absolute top-14 right-0 bg-gray-800 border border-gray-700 rounded-md p-2">
//                   <NavLink
//                     to="#"
...
//           </div>
//           <div className="flex xl:items-center xl:ml-4">
//             <button className="hover:rounded-full mx-4 my-0 size-8 hover:border hover:border-gray-700 hover:focus:ring-slate-900 hover:focus:ring-4 items-center flex justify-center hover:bg-slate-200 hover:bg-opacity-5">
//               <svg
//                 className="size-6 text-white xl:hidden"
//                 xmlns="http://www.w3.org/2000/svg"
//                 viewBox="0 0 24 24"
...
//             </button>
//             {/* User profile */}
//             <button className="hover:rounded-full size-8 hover:border hover:border-gray-700 hover:focus:ring-slate-900 hover:focus:ring-4 items-center flex justify-center hover:bg-slate-200 hover:bg-opacity-5">
//               <img
//                 className="h-8 w-8 rounded-full"
//                 src="https://via.placeholder.com/30"
//                 alt="User"
      ...
      <div className="px-4 md:px-10 xl:px-12">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="text-white space-x-3 flex items-center xl:space-x-6">
            ...
            <form>
              <button
                className="w-28 xl:w-24 px-0 font-semibold text-xs BtnEx1 z-10 hidden xl:block"
                style={{ height: "31px" }}
              >
                SUBSCRIBE
              </button>
