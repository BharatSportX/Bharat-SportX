...
import "./Postpage.css"; // Assuming you have a CSS file for custom styles
    ...
    <div>
      ...
      {modalOpen && (
        <div>
          ...
          >
            <div
              className="relative p-4 w-full max-w-md modal-content"
              onClick={stopPropagation} // Prevent closing when clicking inside the modal content
              data-aos="zoom-in-up" // AOS animation class
            >
              {/* Modal content */}
              <div className="relative text-white bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="flex items-center justify-between p-4 border-b rounded-t">
                  ...
                  <button
                    onClick={closeModal}
                    className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 dark:text-white rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center close-btn"
                    type="button"
                  >
                    <svg
                      className="w-3 h-3"
