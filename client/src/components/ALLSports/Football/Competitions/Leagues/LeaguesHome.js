...
const LeaguesHome = () => {
    ...
    return (
        <section className="dark:bg-gray-900 h-full relative overflow-x-hidden top-36 bg-cover bg-center" style={{ backgroundImage: 'url(your-background-image-url.jpg)' }}>
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                <div className="grid grid-cols-2 md:grid-cols-6 gap-4 justify-center mt-4">
                    <div>
                        <button
                            className={
                                activeButtons[0]
