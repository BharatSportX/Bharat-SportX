    ...
    <div className="frontBody h-screen flex flex-col relative">
      ...
      <section className="">
        <div className="flex flex-col justify-center text-center items-center h-full px-3 absolute top-0 left-0 right-0 bottom-0">
          <h1 className="mb-4 text-4xl font-bold font-[Acme,sans-serif]  leading-normal text-white tracking-wide md:text-5xl lg:text-6xl">
            {text}
          ...
          <div className=" ">
            <Link
              to="/LeagueHome"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black rounded-lg bg-yellow-300 hover:bg-yellow-300  hover:font-semibold dark:focus:ring-blue-900 button shadow-lg     md:font-semibold  md:text-2xl font-[Josefin Sans,sans-serif]" 
            >
              Get Started
              <svg
